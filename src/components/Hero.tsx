    ...
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 relative overflow-hidden">
      ...
      <div className="container relative">
        <div className="flex items-center justify-center">
          ...
          >
            <span className="bg-[linear-gradient(to_right,#F87AFF,#FB93D0,#FFDD99,#C3F0B2,#2FD8FE)] from-red-500 to-blue-500 text-transparent bg-clip-text [-webkit-background-clip:text]">
              version 2.0 is here
            </span>
        ...
        <div className="flex justify-center mt-8">
          <div className="inline-flex relative">
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tighter text-center inline-flex">
            Blockchain Powered, 
              <br />Biometric Verified
            </h1>
            <motion.div
